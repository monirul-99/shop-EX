...
const Bonus = () => {
  return (
    <>
      <div className="container mx-auto bg-white text-black px-5 pt-12 pb-28">
      ...
      <div className="relative bg-[#A2C8D9] py-16 grid lg:grid-cols-12 justify-between items-center container mx-auto ">
        ...
        <div className="grid col-span-7 ">
          <img
            className="absolute bottom-0 w-[95%] left-60 hidden lg:block"
            src={Model}
            alt=""
          />
        </div>
      ...
      <div className="h-20 bg-white container mx-auto"></div>
    </>
  );
};
